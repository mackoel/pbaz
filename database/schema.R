...
SQL <- c(
	"CREATE VIEW clim_pheno
	 ...
	 SELECT
		...
		(SELECT origin_region FROM variety WHERE variety.name = phase_transition_time.variety) as origin_region,
		(SELECT colsite FROM variety WHERE variety.name = phase_transition_time.variety) as colsite,
